"""
Django settings for dermalink_45555 project.
...
ROOT_URLCONF = 'dermalink_45555.urls'
...
WSGI_APPLICATION = 'dermalink_45555.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dermalink_45555 API",
    "DESCRIPTION": "API documentation for dermalink_45555 App",
    "VERSION": "v1",
}
